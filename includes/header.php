...
{               ?>
        ...
        <div class="social">
          <ul>
            ...
            <li><a href="https://dribble.com"><i class="dribble"></i></a></li>  
            <li><a href="https://google.com"><i class="google"></i></a></li>                   
          </ul>
        </div>
      </div>
...
foreach($results as $row)
{               ?>
          <li class="top_link">Email: <?php  echo htmlentities(string: $row->Email);?></li>|
          <li class="top_link">Telephone : +91  <?php  echo htmlentities(string: $row->MobileNumber);?></li>|          
        <?php $cnt=$cnt+1;}} ?>
        </ul>
